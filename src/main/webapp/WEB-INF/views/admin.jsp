...
<%@ page import="com.druid.model.SysUser" %>
...
<div id="navbar" class="navbar navbar-default">
    <div class="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="/admin/page.index" class="navbar-brand">
                <small>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/dept/dept.page" width="99%"  style="min-height: 900px;"></iframe>
    </div>
    <!-- /.main-content -->
